...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-12-2023 a las 15:52:37
-- Versión del servidor: 10.4.24-MariaDB
-- Versión de PHP: 8.1.6

CREATE DATABASE IF NOT EXISTS BD2ORACLE; 
USE BD2ORACLE;
...
(2, 'blusa', 'dasda', '12', 'blanco', 'blusa.jpg', 9, 100, 0, 25, 1),
...
--
ALTER TABLE `domicilio`
  MODIFY `dom_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `linea`
  MODIFY `lin_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `pedido`
  MODIFY `ped_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tipoxproducto`
  MODIFY `txp_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
